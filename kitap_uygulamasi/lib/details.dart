...
class _DetailsState extends State<Details> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomBar(bookObject: widget.bookObject,),
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      SizedBox(width: 5),
                      Text(widget.bookObject.rating.toString(),
      ...
      child: ListView(
        ...
        children: <Widget>[
          CategoryBox(
            ...
            categoryIcon :"https://cdn3.vectorstock"
                ".com/i/thumb-large/93/62/psychology-icon-vector"
                "-15909362.jpg",
          ),
          ...
          CategoryBox(
            ...
            categoryIcon :"https://cdn3.iconfinder.com/data/icons/design-tools-14/24/_translation-256.png",
          ),
          SizedBox(width: 15,),
          CategoryBox(
            category: "YAŞ",
            categoryValue:widget.bookObject.age,
            categoryIcon :"https://image.flaticon"
                ".com/icons/png/512/31/31370.png"),
        ],
      ),
    );
  }
    ...
    return Expanded(
      child: RichText(
        text: TextSpan(
          children:[
            TextSpan(
              text: "${widget.bookObject.price} TL",
              style: TextStyle(
                color: Colors.black87,
                fontFamily: "lovelo",
                fontSize: 30,
            ...
            TextSpan(
              text: "${(widget.bookObject.price + 5.45).toString()} TL",
...
_addToCart(){
  inCart = !inCart;
  buttonText = (inCart==false) ? "Sepete Ekle " : "Sepetten Kaldır";
